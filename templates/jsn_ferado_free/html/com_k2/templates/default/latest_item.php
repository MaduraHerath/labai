			...
			<div class="catItemImageBlock"> 
				...
				<!-- Date created -->
					<div class="createdate">
						<?php $date = printf('<span class="createdate-day">'.JHtml::_('date', $this->item->created, JText::_('d')).'</span>'.'<span class="createdate-month">'.JHtml::_('date', $this->item->created, JText::_('M')).'</span>'.'<span class="createdate-year">'.JHtml::_('date', $this->item->created, JText::_('Y')).'</span>'); ?>
					</div>
				<?php endif; ?>
