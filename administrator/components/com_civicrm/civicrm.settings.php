...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://Madura Herath:madurajaba123@localhost/joomlavm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://Madura Herath:madurajaba123@localhost/joomlavm?new_link=true');
  }
}
...
$civicrm_root = 'C:\wamp\www\labai\administrator\components\com_civicrm\civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\wamp\www\labai\media\civicrm\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/labai/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'c2b0437f696b74e5969fe608c66e5f96');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\wamp\www\labai\media\civicrm\templates_c/mail.log');
// }
